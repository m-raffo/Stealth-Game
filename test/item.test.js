...
describe('Item tests', function() {
  ...
  it('should determine when .checkCollisionPoint is true (box)',
      function(done) {
  ...
  it('should determine when .checkCollisionPoint is false (box)',
      function(done) {
  ...
  it('should determine when .checkCollisionPoint is true (circle)',
      function(done) {
  ...
  it('should determine when .checkCollisionPoint is false (circle)',
      function(done) {
        testItem.collisionShape = 'circle';
  ...
  it('should determine when .checkCollision is true (box and box)',
      function(done) {
